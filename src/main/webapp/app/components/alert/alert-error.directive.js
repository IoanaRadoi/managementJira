(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('managementJiraApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-managementJiraApp-error');
                var entityKey = httpResponse.headers('X-managementJiraApp-params');
                if (errorHeader) {
